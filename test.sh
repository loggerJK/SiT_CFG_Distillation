...
python -m torch.distributed.run  --nnodes=1 --nproc_per_node=1 train.py --model SiT-XL/2 --data-path /media/dataset1/ImageNet2012/train --ckpt /media/dataset2/jiwon/representation/SiT/checkpoint/SiT-XL-2-256.pt --wandb --global-batch-size 4 --sample-every 5